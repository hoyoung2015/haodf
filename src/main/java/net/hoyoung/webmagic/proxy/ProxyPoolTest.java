package net.hoyoung.webmagic.proxy;
...
public class ProxyPoolTest {
	...
	public ProxyPoolTest() {

	}

	public ProxyPoolTest(List<String[]> httpProxyList) {
		readProxyList();
	...
	public static void main(String[] args) throws IOException {
		ProxyPoolTest proxyPool = new ProxyPoolTest(getProxyList());
